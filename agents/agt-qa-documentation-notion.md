...
1. **Apply the skill** `qa-notion-documentation` (see `.cursor/skills/qa/skill-qa-notion-documentation/SKILL.md`). All rules for hierarchy, BDD language (pt-BR), page structure, metadata, and Notion Markdown come from the skill.
2. **Checklist:**
   ...
   (2) Translate technical steps into BDD (Dado/Quando/Então) in pt-BR, without WebdriverIO jargon;
